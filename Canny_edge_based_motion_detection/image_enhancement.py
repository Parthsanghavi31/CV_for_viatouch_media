...
if __name__=="__main__":
    ...
    filename = "/home/parth/Viatouch_Media_Projects/image_enhancement/frames/frames110.jpg"
    image = imageio.imread(filename)  # load image
    
    # setting up parameters
    parameters = {}
    parameters['local_contrast'] = 4  # 1.5x increase in details
    parameters['mid_tones'] = 0.5
    parameters['tonal_width'] = 0.4
    parameters['areas_dark'] = 0.4  # 70% improvement in dark areas
    parameters['areas_bright'] = 0.2  # 50% improvement in bright areas
    parameters['saturation_degree'] = 1.5 # 1.2x increase in color saturation
